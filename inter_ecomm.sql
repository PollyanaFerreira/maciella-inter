...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30/11/2023 às 15:54
...
--
ALTER TABLE `carrinho`
  MODIFY `id_produto_car` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
